...
6. **Production acceptance — requires local GPU run.** Generate and accept five PDD REF2VA cards, restart ComfyUI, resume, and generate Card 6 while checking identity/reference influence and the AV seam.

Scope remains limited to a fixed generation mode and direct latent continuation. Drift-control methods and mixed card modes remain later work.
